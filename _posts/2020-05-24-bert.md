...
- 자체적인 regularization 효과가 생겨서 dropout 효과를 기대할 수 있다. 즉 dropout을 해도 무방한 효과를 갖게 된다. (dropout을 추가할 경우 학습속도도 느려지는 영향이 있다.)
...
```
이렇게 하면 각각의 데이터(example)를 서로서로 독립적으로 Normalization하게 된다. 

## TBD
Layer Normalization은 아래와 같은 장점/(단점)을 가진다.
...
![Figure 1](http://github.com/jinkilee/jinkilee.github.io/blob/master/img/bert/bert.png)
|:--:|
...
![Figure 2](http://github.com/jinkilee/jinkilee.github.io/blob/master/img/bert/bert1.png)
|:--:|
...
![Figure 3](http://github.com/jinkilee/jinkilee.github.io/blob/master/img/bert/bert2.png)
|:--:|
| *Figure 3: BERT: with 12 BertLayers and BertEncoding* |
`BertLayer`에서 어떤 일이 일어나는지를 봐보자. 이거 하나만 보면 나머지는 같은일 12번 반복일 뿐이다.

![Figure 4](http://github.com/jinkilee/jinkilee.github.io/blob/master/img/bert/bert_layer.png)
|:--:|
...
![Figure 5](http://github.com/jinkilee/jinkilee.github.io/blob/master/img/bert/inter_out.png)
|:--:|
| *Figure 5: BertLayer: BertIntermediate and BertOutput* |
- `BertIntermediate`: Linear + Activation
- `BertOutput`: Linear + LayerNormalization

![Figure 6](http://github.com/jinkilee/jinkilee.github.io/blob/master/img/bert/attention.png)
|:--:|
...
![Figure 7](http://github.com/jinkilee/jinkilee.github.io/blob/master/img/bert/inter_out.png)
|:--:|
...
![Figure 8](http://github.com/jinkilee/jinkilee.github.io/blob/master/img/bert/selfattention.png)
|:--:|
