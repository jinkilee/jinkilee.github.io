...
2월 달에 seq2seq 모델과 attention을 이용해서 한국어-영어 번역기를 만들어봤다. 이번에는 한국어-영어 번역기를 트랜스포머 형태로 만들어보려고 한다. 트랜스포머를 이용해서 번역기를 만들 경우 번역 품질이 얼마나 더 좋아지는지 문장으로 그리고 BLEU 스코어를 기준으로 알아보자.
...
[**attention is all you need 설명**](http://jalammar.github.io/illustrated-transformer/)
